...
import { ScanFace, Droplets, Sun, Clock, Zap, ChevronRight, ShoppingBag } from 'lucide-react-native';
        ...
        useCallback(() => {
            async function getRecentDetections() {
                try {
                    ...
                    setResults(flatDetections.slice(-3).reverse());
                } catch {
                    setResults([]);
                }
            }
        ...
        <ThemedView style={styles.container}>
            ...
            >
                ...
                <TouchableOpacity
                    ...
                    onPress={() => router.push('/(drawer)/acneType')}
                    activeOpacity={0.88}
                >
                            ...
                            {results.map((result, index) => {
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            styles.scanItem,
                                            index < results.length - 1 && styles.scanItemBorder,
                                        ]}
                                    ...
                                    >
                                        ...
                                        <View style={styles.scanItemRight}>
                                            <View style={styles.spotsBadge}>
                                                <ThemedText style={styles.spotsBadgeText}>
                ...
                {/* Browse Products */}
                <TouchableOpacity
                    style={[styles.productsRow, { backgroundColor: cardBg }]}
                    onPress={() => router.push('/(drawer)/findProducts')}
                    activeOpacity={0.8}
                >
                    <View style={styles.productsIcon}>
                        <ShoppingBag size={18} color={Colors.primary_800} />
                    </View>
                    <View style={styles.productsText}>
                        <ThemedText style={styles.productsTitle}>Browse Products</ThemedText>
                        <ThemedText style={styles.productsSub}>AI-recommended skincare</ThemedText>
                    </View>
                    <ChevronRight size={16} color={Colors.primary_400} />
                </TouchableOpacity>
                                ...
                                <View key={tip.id} style={styles.tipSlide}>
                                    <View style={[styles.tipCard, { backgroundColor: tip.bg }]}>
                                        ...
                                        <View style={styles.tipBody}>
                                            ...
                                            <ThemedText style={styles.tipText} numberOfLines={2}>{tip.tip}</ThemedText>
                                        </View>
                                    </View>
                                </View>
                            );
